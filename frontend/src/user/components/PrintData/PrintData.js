...
"}
        ...
        <div className="print-container">
          ...
          <table cellPadding={3}>
            ...
            <tr>
              <td rowSpan={3} className="print-label">
                Surname
                <br></br>
                <br></br>
                First Name
              ...
              <td colSpan={7}>
                {props.userData.lastName ? props.userData.lastName : "N/A"}
              </td>
            </tr>
            <tr>
              <td colSpan={4}>{props.userData.firstName}</td>
              <td colSpan={2} className="print-label">
                Extension Name
              </td>
              <td>
              ...
              <td colSpan={4} rowSpan={3}>
                ...
                >
                  <tr>
                    ...
                    <td>
                      {props.userData.houseNoR
                        ? props.userData.houseNoR
                        : "N/A"}
                    </td>
                    <td className="print-label">Street:</td>
                    <td>
                      {props.userData.streetR ? props.userData.streetR : "N/A"}
                    </td>
                  </tr>
                  <tr>
            ...
            <tr>
              ...
              <td rowSpan={4} className="print-label">
                Pemanent Address
              </td>
              <td colSpan={4} rowSpan={4}>
                ...
                >
                  <tr>
                    <td className="print-label">House no.:</td>
                    <td>
                      {props.userData.houseNoP
                        ? props.userData.houseNoP
                        : "N/A"}
                    </td>
                    <td className="print-label">Street:</td>
                    <td>
                      {props.userData.streetP ? props.userData.streetP : "N/A"}
                    </td>
                  </tr>
                  <tr>
                    <td className="print-label">Subdivision:</td>
            ...
            <tr>
              ...
              <td colSpan={2}>
                {props.userData.gssId ? props.userData.gssId : "N/A"}
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colSpan={2}>
                {props.userData.sssNo ? props.userData.sssNo : "N/A"}
              </td>
              <td className="print-label">Telephone no.</td>
              <td colSpan={4}>
                {" "}
                {props.userData.telephoneNum
                  ? props.userData.telephoneNum
                  : "N/A"}
              </td>
            </tr>
            <tr>
              ...
              <td colSpan={2}>
                {props.userData.tinNo ? props.userData.tinNo : "N/A"}
              </td>
              <td className="print-label">Cellphone no.</td>
              <td colSpan={4}>
                {props.userData.cellphoneNum
                  ? props.userData.cellphoneNum
                  : "N/A"}
              </td>
            </tr>
            <tr>
              ...
              <td colSpan={2}>
                {props.userData.citizenship
                  ? props.userData.citizenship
                  : "N/A"}
              </td>
              <td className="print-label">Alternate Email</td>
              <td colSpan={4}>
                {props.userData.alternateEmail
                  ? props.userData.alternateEmail
                  : "N/A"}
              </td>
            </tr>
